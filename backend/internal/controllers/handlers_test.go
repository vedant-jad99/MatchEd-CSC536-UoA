...
func TestHandleCreateUser(t *testing.T) {
	original := models.CreateUser
	models.CreateUser = func(u models.User) error { return nil }
	defer func() { models.CreateUser = original }()
...
func TestHandleFetchAllPreferences(t *testing.T) {
	...
	models.FetchAllPreferences = func(s string) ([]models.Preferences, error) {
		return []models.Preferences{{Semester: s}}, nil
	}

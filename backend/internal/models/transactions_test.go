...
func TestCreateUserAndFetchAllFaculty(t *testing.T) {
	...
	CreateUser(User{Name: "Alice", Email: "alice@test.com", NumReqCourses: 3})
	CreateUser(User{Name: "Bob", Email: "bob@test.com", NumReqCourses: 2})
...
func TestFetchAllPreferences(t *testing.T) {
	...
	prefs, err := FetchAllPreferences("Spring")
	assert.Nil(t, err)
